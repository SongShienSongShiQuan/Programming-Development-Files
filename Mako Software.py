...
class Aplikasi:
    def __init__(self, master: ctk.CTk):
        ...
        self.Activate_Const_RAM_Release_Button_output = ctk.CTkLabel(self.master, text='CONST RAM RELEASE', font=('Helvetica bold',26), bg_color="black")
        self.Activate_Const_RAM_Release_Button_output.place(relx=0.7, rely=0.15, anchor='center')
